			...
			<table id="table" class="table table-striped table-bordered">
				...
				<?php if(!count($query->result())) echo " Không có hồ sơ nào.";
					...
					<div class="modal-body">';
							...
							$attributes = array('class' => 'error-form');
							echo form_open(''.base_url('admin/admin_phong_ban/notifyError/'.$row->id.'/'.$row->cmnd.'').'',$attributes);
						...
						'.$da_thu[$i].'
						<br><textarea type="text" class="form-control" style="margin-top:15px;" cols="60" name="loi_rieng_'.$i.'" placeholder="Nhập lỗi riêng"  value=""></textarea><br>';
								$i++;
							}
							echo'<br>
				...
				<div class="modal-footer">';
							echo form_submit('submit','Xác nhận lỗi','class="btn youtube btn-danger sent_noti_tv"');
...
<script type="text/javascript">
	...
	$('.youtube').on("click",function() {
		...
		//console.log($('.error-form').find('textarea'));
			//do somthing here
